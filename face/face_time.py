...
classfier=cv2.CascadeClassifier("/root/opencv-3.1.0/data/haarcascades/haarcascade_frontalface_default.xml")#定义分类器  改动的地方在这里  添加分类器的绝对路径
